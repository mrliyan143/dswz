...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function playit() {
            ...
            document.write('<embed src="images/hdtp/bcastr3.swf" wmode="opaque" FlashVars="bcastr_file=' + files + '&bcastr_link=' + links + '&bcastr_title=' + texts + '&bcastr_config=' + configtg + '&menu="false" quality="high" width="' + swf_width + '" height="' + swf_height + '" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />');
                        ...
                        <c:forEach items="${tbooks}" var="tbook" varStatus="status">
                            <c:if test="${tbook.tbook_show==1}">
                                <li>
                                    <div>
                                        <div class="info_text">
                                            <a href="page_queryTbook.action?tbook_id=${tbook.tbook_id}" target="_blank"
                                               title="${tbook.tbook_name}">
