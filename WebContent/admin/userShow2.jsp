...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">会员用户管理&gt;&gt;会员用户查询</span>
</div>
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <tr class="list0" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center">
       <a href="Admin_editUser2.action?user_id=${user.user_id}">编辑</a>
     </td>
   </tr> 
   </c:forEach>
   </c:if>
   <c:if test="${users==null ||  fn:length(users)==0}">
   <tr>
     <td height="60" colspan="19" align="center"><b>&lt;不存在会员用户信息&gt;</b></td>
   </tr>
  </c:if>
